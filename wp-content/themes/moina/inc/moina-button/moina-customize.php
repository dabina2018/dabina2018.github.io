...
final class Moina_Upgrade_Pro_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Moina_Upgrade_Pro_Customize_Section_Pro(
				...
				'upgrade_button',
				array(
					'title'    => esc_html__( 'Moina Pro', 'moina' ),
					'pro_text' => esc_html__( 'Upgrade Pro', 'moina' ),
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_style( 'moina-upgrade-button-customize-controls', trailingslashit( esc_url( get_template_directory_uri() ) ) . 'inc/moina-button/customize-controls.css' );
	}
}
